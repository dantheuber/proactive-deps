...
* [DependencyMonitor](#DependencyMonitor)
    ...
    * [.getStatus(dependencyName)](#DependencyMonitor+getStatus) ⇒ [<code>Promise.&lt;DependencyStatus&gt;</code>](#DependencyStatus)
...
### dependencyMonitor.getStatus(dependencyName) ⇒ [<code>Promise.&lt;DependencyStatus&gt;</code>](#DependencyStatus)
<p>Gets the status of a specific dependency by name.</p>

**Kind**: instance method of [<code>DependencyMonitor</code>](#DependencyMonitor)  
**Returns**: [<code>Promise.&lt;DependencyStatus&gt;</code>](#DependencyStatus) - <p>The status of the dependency.</p>  
**Throws**:
