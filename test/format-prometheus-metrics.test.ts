...
describe('formatPrometheusMetrics', () => {
  it('should generate Prometheus metrics for dependencies', () => {
    const dependencies = [
      { name: 'redis', healthy: true, latencyMs: 50, code: SUCCESS_STATUS_CODE, message: SUCCESS_STATUS_MESSAGE },
      { name: 'db', healthy: false, latencyMs: 100, code: ERROR_STATUS_CODE, message: ERROR_STATUS_MESSAGE },
    ];
